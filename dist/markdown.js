...
function isNonzeroYear(value, offset) {
...
function validateOptionObject(options) {
    if (!isRecord(options))
...
function validateLinkObject(linksValue) {
...
export function sebastianTheme(options) {
